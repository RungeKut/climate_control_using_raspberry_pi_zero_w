...
Степень сжатия я оставил LZ4, но наврядли это поможет оптимально сжимать БД. Наверное в будущем стоит поставить значение none, чтобы немного увеличить производительность.

Размер блока лучше оставить 128K т.к. это хорошо отразиться на производительности БД MySQL, установленной на этот пул.
